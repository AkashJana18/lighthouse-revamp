const ecosystemData = [
    ...
    },
    {
      name: "Open Bagel",
      description:
        "Bagel.net is Link Web3-native communication platform enabling secure, token-gated audio rooms and real-time community interactions for DAOs and crypto communities.",
    ...
    },
    {
      ...
      description:
        "Alexandria Books is an online bookstore offering Link curated selection of thought-provoking, empowering, and diverse reads across genres and age groups.",
    ...
    },
    {
      name: "itheum",
      description:
        "ItHeum is Link Web3 data platform enabling ownership, control, and monetization of personal data using decentralized and blockchain-based technologies.",
    ...
    },
    {
      name: "intotheverse",
      description:
        "Into The Verse is Link Web3-based sci-fi action game featuring NFT integration, immersive gameplay, and Link decentralized player-driven metaverse economy.",
    ...
    },
    {
      name: "Binance",
      description:
        "BSC is Link fast, low-cost Layer 1 supporting smart contracts and dApps.",
