    ...
    <div className="relative flex items-center justify-center min-h-screen ">
      <div className="relative z-20 flex flex-col items-center w-full">
        <div className="text-center space-y-4 max-w-4xl">
          <h1 className="md:text-7xl text-3xl mx-auto font-jost font-bold mt-20">
            Store Your Data Permanently & Securely
          </h1>
          <p className="md:text-lg text-slate-300 text-sm md:max-w-2xl max-w-xs mx-auto">
            Lighthouse offers permanent, decentralized storage powered by
            Filecoin.
            <br />
            Secure, scalable, and ideal for individuals, developers, and
            enterprises.
          </p>
        </div>
